...
function <SID>TExpandVars()
	...
	let l:userone    = exists("g:usernameone") ? g:usernameone :
				     \ (exists("g:userone") ? g:userone : $USERONE)
	let l:usertwo    = exists("g:usernametwo") ? g:usernametwo :
				     \ (exists("g:usertwo") ? g:usertwo : $USERTWO)
	let l:email      = exists("g:email") ? g:email : (l:user . "@" . l:hostn)
	let l:emailone   = exists("g:emailone") ? g:emailone : (l:userone . "@" . l:hostn)
	let l:emailtwo   = exists("g:emailtwo") ? g:emailtwo : (l:usertwo . "@" . l:hostn)
	...
	call <SID>TExpand("USERONE",  l:userone)
	call <SID>TExpand("USERTWO",  l:usertwo)
	...
	call <SID>TExpand("MAILONE",  l:emailone)
	call <SID>TExpand("MAILTWO",  l:emailtwo)
